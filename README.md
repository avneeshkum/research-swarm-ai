...
**[📄 Attention Is All You Need — Research Brief](sample-outputs/attention-is-all-you-need-brief.pdf)**
...
```bash
git clone https://github.com/yourusername/swarmlab.git
cd swarmlab
```
...
- [x] Streaming responses (token-by-token output)
